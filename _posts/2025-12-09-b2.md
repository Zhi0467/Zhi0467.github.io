...
date: 2025-12-09
permalink: /posts/2025/post2/
tags:
  - RL
header:
  teaser: p2/1.png
  teaser_alt: "Policy-gradient formulas from the reward and value post"
---
...
since $Q(s_t,a_t) = \mathbb{E}_{\pi}[G_t \mid s_t, a_t]$, we have:
...
Happy new year! I have been busy with another that actually uses RL heavily so I will come back to share more on both the theory and some lessons I learned from the practical/engineering side of the project.
